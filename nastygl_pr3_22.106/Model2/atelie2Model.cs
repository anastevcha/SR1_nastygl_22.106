...
{
    public partial class atelie2Model : DbContext
    {
        private static atelie2Model _instance;
        public atelie2Model()
            : base("name=atelie2Model")
        {
        }
        public static atelie2Model GetContext()
        {
            if (_instance == null)
            {
                _instance = new atelie2Model();
            }
            return _instance;
        }
